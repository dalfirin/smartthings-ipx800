 ...
 */
metadata {
	definition (name: "IPX800 Window Shade control test", author: "piXelPoivre") {
    ...
    preferences {
    input("IPX800_IP", "string", title:"IPX800 IP Address", description: "Please enter your camera's IP Address", required: true, displayDuringSetup: true)
